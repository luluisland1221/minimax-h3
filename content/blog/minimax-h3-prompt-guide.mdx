---
title: "MiniMax H3 Prompt Guide for Video, Camera, and Sound"
...
- Build a clean first request with the [Text to Video guide](/docs/text-to-video).
- Control endpoints with [First and Last Frame](/docs/first-last-frame).
- Assign image, video, and audio roles with [Multimodal Reference](/docs/multimodal-reference).
- Plan motion transfer with the [Reference-to-Video guide](/blog/minimax-h3-reference-to-video-guide).
- Protect recurring subjects with the [Character Consistency guide](/blog/minimax-h3-character-consistency).
- Turn the structure into an advertising brief with [Product Video Prompts](/blog/minimax-h3-product-video-prompts).
- Write a natural vertical testimonial with [UGC Video Prompts](/blog/minimax-h3-ugc-video-prompts).
- Build a multi-shot sequence with the [Music Video Workflow](/blog/minimax-h3-music-video-workflow) or [Game Cinematic Prompts](/blog/minimax-h3-game-cinematic-prompts).
- Paste any example prompt into the [MiniMax H3 Playground](/#playground) and change one directing layer at a time.
