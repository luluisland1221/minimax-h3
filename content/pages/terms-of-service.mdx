...
description: Review the terms governing accounts, credits, subscriptions, video generation, acceptable use, and responsibilities when using minimaxh3.pro.
date: "2025-03-10"
published: true
---
...
These Terms of Service ("Terms") govern your use of the independent MiniMax H3 website and services. By accessing or using our services, you agree to be bound by these Terms.

> **Independent service notice:** MiniMax H3 is an independent third-party service and is not affiliated with, endorsed by, or operated by MiniMax. MiniMax and related names or marks belong to their respective owners.
...
If you have any questions about these Terms, email [support@minimaxh3.pro](mailto:support@minimaxh3.pro) or [contact us](/contact).
